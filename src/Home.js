...
const Home = () => {
    ...
    const [blobs, setBlobs] = useState([
        {id: 1, borderRadius: '57% 43% 72% 28% / 51% 55% 45% 49%', background: '--green', height: '45rem', width: '45rem', lr: '-30vw', tb: '-20vh', offsetTop: '1rem', offsetLeft: '1rem'},
        ...
        {id: 4, borderRadius: '35% 65% 42% 58% / 67% 41% 59% 33%', background: '--magenta', height: '20rem', width: '20rem', lr: '-120vw', tb: '55vh', offsetTop: '-2rem', offsetLeft: '1rem'},
